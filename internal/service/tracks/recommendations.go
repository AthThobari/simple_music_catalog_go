...
func modelToRecommendationResponse(data *spotifyRepo.SpotifyRecommendationsResponse, mapTrackActivities map[string]trackactivities.TrackActivity) *spotify.RecommendationResponse {
	if data == nil {
		return nil
	}
